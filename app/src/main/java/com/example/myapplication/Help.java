...
public class Help extends Fragment {
    ...
    public void InitializeData() {
        ...
        dataList.add(new HelpItem("김현경","상일텃밭 농부","54초 전","혹시 오늘 상일텃밭 가시는 회원 있으신가요? 제 텃밭에 물을 줘야하는데.. 지금 제가 가지 못해서요ㅠㅜㅠㅜ", 2, 4));
        dataList.add(new HelpItem("이지훈","상일텃밭 농부","10분 전","오늘 상일텃밭 도움 필요하신 분~ 저 오늘 물 주러 가는데 도움 필요하신 분 계신가요~^^?", 6,15));
        dataList.add(new HelpItem("정승환","강일텃밭 농부","10분 전","토요일에 텃밭 가서 고구마 수확하려고 하는데, 도와주실 분 계신가요~~ 다음에 저도 품앗이 하겠습니다!!", 12,11));
        dataList.add(new HelpItem("강대영","암사텃밭 농부","1시간 전","혹시 물뿌리개 있으신 분 계신가요?? 저 좀 빌려주실 분 찾아요~", 3,1));
        dataList.add(new HelpItem("유하은","강일텃밭 농부","1일 전","강일텃밭 회원이신 분들 중 토요일에 도움 필요하신 분 계신가요?", 6,3));
        dataList.add(new HelpItem("원지수","상일텃밭 농부","1일 전","혹시 고구마 모종 구하시는 분~ 많이 남아서 글 남겨요!", 6,12));
