...
public class Guide_detail extends Fragment {
    public static Guide_detail newInstace(){ return new Guide_detail();}
    private View view;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.guide_detail, container, false);
